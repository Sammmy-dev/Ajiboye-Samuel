...
export const projects: Project[] = [
  {
    ...
    title: "TBMI Studio",
    tagline:
      "A full-stack creative studio platform for lead capture and course enrollment.",
    description:
  ...
  },
  {
    ...
    title: "FAR",
    tagline:
      "A staffing and HR operations platform for recruitment, deployment, and internal workforce management.",
    description:
...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    items: ["AI APIs", "LangChain", "LangGraph", "RAG", "LLM"],
  },
  {
    category: "Infrastructure",
    items: ["AWS", "Vercel", "Docker", "GitHub Actions", "Kubernetes",],
  },
];
